...
public class MenuSystem {
    ...
    public static void printMainMenu() {
        ...
        System.out.println("| 2. Person Queries - actors, directors, writers                 |");
        System.out.println("| 3. Character Queries - characters and who played them          |");
    ...
    public static void printHelp() {
        ...
        System.out.println("|   1. Title Queries - Complex searches for movies/TV      |");
        System.out.println("|   2. Person Queries - Actor/director collaborations      |");
        System.out.println("|   3. Character Queries - Character portrayals            |");
        System.out.println("|   4. Series Queries - Episode and season analysis        |");
        System.out.println("|                                                          |");
    ...
    public static void printTitleMenu() {
        ...
        System.out.println("| 1. Search Title by Name                                        |");
        System.out.println("| 2. Get Title Details (by ID)                                   |");
        System.out.println("| 3. View Alternative Titles for a Movie                         |");
        ...
        System.out.println("| 11. Global vs Regional Title Performance                       |");
        ...
        System.out.println("| 15. TV Series: Season Ratings vs Writer Count                  |");
        System.out.println("+----------------------------------------------------------------+");
    ...
    public static void printPersonMenu() {
        ...
        System.out.println("| 3. Search People by Profession                                 |");
        System.out.println("| 4. Get Actor/Actress Age                                       |");
        System.out.println("| 5. View All Professions                                        |");
        System.out.println("+----------------------------------------------------------------+");
        System.out.println("| COMPLEX QUERIES                                                |");
